				...
				<tbody>
					...
					<tr>
						<td><b class="insert_title">제목</b> <input name="title"
							 id="title" class="title_input" maxlength="30">
							<a style=" color: red; text-decoration: none;" href="#"><span>TIP</span>
    						<p class="arrow_box">"한글, 영어,숫자포함 30자 이하 글자(공백없음)"</p></a></td>
					</tr>
					<tr>
						<td class="wrap"><b class="insert_content">내용</b> 
					<textarea  class="text_input"  maxlength="500" name="content" id="content" ></textarea></td>
					</tr>
					<tr>
					<td>
					<span  id="counter" ></span><!-- onFocus="clearMessage(this.form);onchange="textarea(this)"" -->
					</td></tr>
				</tbody>
			</table><!--  -->
			<div>
